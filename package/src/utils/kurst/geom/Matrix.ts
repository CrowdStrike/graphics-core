...
export class Matrix {
  ...
  concat(matrix: Matrix): void {
    let a1 = this.a * matrix.a + this.b * matrix.c;

    this.b = this.a * matrix.b + this.b * matrix.d;
    this.a = a1;

    let c1 = this.c * matrix.a + this.d * matrix.c;

    this.d = this.c * matrix.b + this.d * matrix.d;

    this.c = c1;

    let tx1 = this.tx * matrix.a + this.ty * matrix.c + matrix.tx;
  ...
  invert(): void {
    ...
    if (norm == 0) {
      ...
      let tx1 = -this.a * this.tx - this.c * this.ty;
  ...
  rotate(angle: number): void {
    ...
    let a1 = this.a * cos - this.b * sin;

    this.b = this.a * sin + this.b * cos;
    this.a = a1;

    let c1 = this.c * cos - this.d * sin;

    this.d = this.c * sin + this.d * cos;
    this.c = c1;

    let tx1 = this.tx * cos - this.ty * sin;
