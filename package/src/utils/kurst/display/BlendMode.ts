...
export class BlendMode {
   ...
   * <code>away.base.static LAYER</code>.
   *
   ...
   * display object be set to <code>flash.display.static LAYER</code>.
   *
   * <p>Not supported under GPU rendering.</p>
   */
  static ERASE = 'erase';
   ...
   * <code>static SHADER</code>. If the <code>blendMode</code> property is
   * set to <code>static SHADER</code> without first setting the
   * <code>blendShader</code> property, the <code>blendMode</code> property is
   * set to <code>static NORMAL</code> instead. If the
   * <code>blendShader</code> property is set(which sets the
   * <code>blendMode</code> property to <code>static SHADER</code>), then
   ...
   * <code>blendMode</code> property to <code>static SHADER</code>. The
